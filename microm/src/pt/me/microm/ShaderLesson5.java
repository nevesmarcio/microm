...
public class ShaderLesson5 implements ApplicationListener {
	...
	public void create() {
		...
		float[] a = new float[] {0f, 0f, 0f, 100f, 100f, 0f, 100f, 0f, 0f};
		meshHelper.createMesh(a);
	...
	public void render() {
		...
		//draw our scene here
//		renderEntities(batch); // comment this line to leave textures out of blur effect
		meshHelper.drawMesh(cam.projection, cam.view, new Matrix4().idt().translate(Gdx.graphics.getWidth()/2, Gdx.graphics.getHeight()/2, 0f), Color.BLACK);
		...
		renderEntities(batch); // whis this here, blur effect do no affect textures
