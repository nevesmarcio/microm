...
public class StarModel extends AbstractModel implements IBodyStatic {
    ...
    private StarModel(final EventBus modelEventBus, final BasicShape star, final String star_name) {
        this.modelEventBus = modelEventBus;
        this.star = star;
        setName(star_name);

        modelEventBus.post(new StarModelEvent(this, StarModelEvent.OnCreate.class));
    ...
    public static StarModel getNewInstance(final EventBus modelEventBus, BasicShape star, String star_name) {
        return new StarModel(modelEventBus, star, star_name);
    }
