...
public abstract class AbstractModel extends EventDispatcher implements Disposable, IGameTick, IContact {
    ...
    public AbstractModel() {
        ...
        if (logger.isDebugEnabled())
            logger.debug("++abstract ctor of {} | allocID: {}", this.getClass().getSimpleName(), (devID = UUID.randomUUID()).toString());
    ...
    public void dispose() {
        if (logger.isDebugEnabled())
            logger.debug("--abstract dispose of {} | allocID: {}", this.getClass().getSimpleName(), devID);
        ...
        for (IBody element : currentContactStatus.keySet()) {
    ...
    private HashMap<IBody, Integer> currentContactStatus = new HashMap<IBody, Integer>();
    ...
    public int addPointOfContactWith(IBody oModel) {
        ...
        try {
            ...
            currentContactStatus.put(oModel, Integer.valueOf(incrementedValue)); // incrementa o nr de contactos com determinado objecto
        } catch (NullPointerException npe) {
            incrementedValue = Integer.valueOf(1);
    ...
    public int subtractPointOfContactWith(IBody oModel) {
        ...
        try {
            ...
            currentContactStatus.put(oModel, Integer.valueOf(decrementedValue)); // decrementa o nr de contactos com determinado objecto
