...
public class WallModelEvent extends AbstractModelEvent implements IModelCategory1/*, IModelCategory2*/ {

    public interface OnTouch extends IEventType {
    }

    public WallModelEvent(AbstractModel eventSource, Class<? extends IEventType> eventType) {
