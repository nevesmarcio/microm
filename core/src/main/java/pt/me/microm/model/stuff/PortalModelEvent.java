...
public class PortalModelEvent extends AbstractModelEvent implements IModelCategory1/*, IModelCategory2*/ {

    public interface OnTouch extends IEventType {}

    public PortalModelEvent(AbstractModel eventSource, Class<? extends IEventType> eventType) {
