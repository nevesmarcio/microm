...
public class SpawnModelEvent extends AbstractModelEvent implements IModelCategory1/*, IModelCategory2*/ {
    ...
    public SpawnModelEvent(AbstractModel eventSource, Class<? extends IEventType> eventType) {
